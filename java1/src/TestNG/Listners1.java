...
public class Listners1 implements ITestListener,IReporter,IInvokedMethodListener,IAnnotationTransformer

{

	@Override
	public void transform(ITestAnnotation annotation, Class testClass, Constructor testConstructor, Method testMethod) {
		annotation.setRetryAnalyzer(TestNG.RetryAnalyzer.class);
	}
	...
	public void onTestFailedButWithinSuccessPercentage(ITestResult result) {
		System.out.println("on Failed But Within Success Percentage" +result.getName());
